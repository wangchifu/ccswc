...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">新增法令規章</li>
    </ol>
</nav>
<form action="{{ route('law.store') }}" method="post" id="this_form" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="file" class="form-label"><span class="text-danger">*</span>附加檔案</label>
        <input class="form-control rq" type="file" id="file" name="file" required>
      </div>
