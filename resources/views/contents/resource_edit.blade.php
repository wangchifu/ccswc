...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">修改網路資源</li>
    </ol>
</nav>
<form action="{{ route('resource.update',$content->id) }}" method="post" id="this_form" enctype="multipart/form-data">
    @csrf
    @method('patch')
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control rq" id="resource" name="resource" required onclick="change_button2()" value="{{ $content->resource }}">
    </div>
