...
@section('content')
<h1>
    {{ $communities[auth()->user()->code] }} 新增行政人員名冊
</h1>
<br>
<br>
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">新增行政人員名冊</li>
    </ol>
  </nav>
<form action="{{ route('staffs.store') }}" method="post" id="this_form" enctype="multipart/form-data">
    @csrf
    <div class="mb-3 w-25">
    ...
    <div class="mb-3 w-25">
      <label for="file" class="form-label"><span class="text-danger">*</span>行政人員名冊表格</label> <a href="{{ asset('excel/staff_sample.xlsx') }}" target="_blank"><i class="fas fa-download"></i> 下載範例檔</a>
